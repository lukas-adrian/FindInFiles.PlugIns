...
{
   /// <summary>
   /// Searching through text files like cs, xml, txt, log, etc. It,s also a default search
   /// </summary>
   public sealed class SearchText : ISearchInFolderPlugIn
   {
      public event EventHandler<FileSearchEventArgs> FileSearchCompleted;
      public event EventHandler<string> DebugOutput;
      
      public String Name { get; } = "SearchText";
      public String Description { get; } = "Searching through text files like cs, xml, txt, log, etc. It,s also a default search";
      public Guid ID { get; } = new Guid("483be2b8-31d4-48ba-aa45-9dac1d8abe29");
