...
/// </summary>
public sealed class SearchPdf : ISearchInFolderPlugIn
{
   public event EventHandler<FileSearchEventArgs> FileSearchCompleted;
   public event EventHandler<string> DebugOutput;
   
   public String Name { get; } = "SearchPdf";
   public String Description { get; } = "Searching through pdf files only";
   public Guid ID { get; } = new Guid("2539ac40-64aa-4eec-bf1e-b4da13d71ba6");
   public List<string> Extensions { get; } = new List<String>{".pdf"};
